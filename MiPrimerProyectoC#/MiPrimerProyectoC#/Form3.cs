...
namespace MiPrimerProyectoC_
{
    public partial class Form3 : Form
    {
        ...
        {//Haciendo un ejerciocion en C# usando matricez , estructuras de control, repeticion y condicionales 
         //calculadora para salario de empleado usando todos los impuestos y deducciones(AFP,ISR,ISSS).
